...
<!-- 
  ...
  <section class="projeto" id="projeto">
      ...
      <div class="rown">
        <div class="col">
          <p>Em 2012 a Reitoria do IFC assinou um convênio entre a Fundação Universidade Regional de Blumenau – FURB e o IFC com o objetivo da cooperação técnico-científica na área da Educação Matemática para implantação de Feiras de Matemática nas Unidades Federativas do Brasil, através da Pró-Reitoria de Extensão do IFC.
